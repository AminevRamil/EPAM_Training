...
/**
 * The {@code ValueComparator} generic class meant to be used to  sort HashMap by value
 *
...
public class ValueComparator<K extends Comparable<K>, V extends Comparable<V>> implements Comparator<Map.Entry<K, V>> {
    ...
    public int compare(Map.Entry<K, V> e1, Map.Entry<K, V> e2) {
        if (e1 == null || e2 == null) throw new NullPointerException("Can't compare null entry by value");
